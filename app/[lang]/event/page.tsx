...
export async function generateMetadata({
  ...
  return createPageMetadata({
    title:
      lang === 'en'
        ? 'IA Webinar - Fernando HOUSSOU'
        : 'Webinaire IA - Fernando HOUSSOU',
    description:
      lang === 'en'
...
export default async function EventPage({ params }: EventPageProps) {
  ...
  const content = {
    fr: {
      ...
      aboutIntro:
        "L'intelligence artificielle transforme déjà tous les secteurs d'activité.",
      ...
      aboutBody2:
        "ce webinaire vous permettra de découvrir comment utiliser concrètement l'IA dans votre domaine afin d'améliorer votre efficacité, automatiser certaines tâches et créer davantage de valeur.",
      aboutBody3:
        "Chaque semaine, Fernando HOUSSOU partage des méthodes pratiques, des outils accessibles et des cas réels d'utilisation adaptés aux réalités africaines.",
      learnTitle: 'Ce que vous allez apprendre',
      learnTagline:
        "Un programme structuré pour passer du curieux à l'expert IA dans votre pratique quotidienne.",
      learnItems: [
        {
          num: '01',
          color: 'color-p1',
          ...
          icon: (
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M11 4a2 2 0 114 0v1a2 2 0 01-2 2H3a2 2 0 01-2-2V4a2 2 0 012-2h8a2 2 0 012 2v1zm4 10a2 2 0 114 0v1a2 2 0 01-2 2H3a2 2 0 01-2-2v-1a2 2 0 012-2h8a2 2 0 012 2v1z"
              />
            </svg>
          ),
        },
      ...
      trainerRole:
        "Spécialiste en productivité numérique, automatisation et intégration de l'intelligence artificielle dans les métiers.",
      trainerBio1:
        'Fondateur et dirigeant de plusieurs projets digitaux en Afrique, il accompagne les professionnels et les entreprises dans leur transformation numérique.',
      trainerBio2:
        "Chaque semaine, il partage des méthodes pratiques, des outils accessibles et des cas réels d'utilisation adaptés aux réalités africaines.",
      ...
      ctaFinalText:
        "Rejoignez des centaines de professionnels africains qui domptent déjà l'IA.",
      ctaFinalBtn: 'Réserver ma place gratuite',
      ctaFinalLimit: 'Places limitées à 250 participants par session',
      testimonialsTitle: 'Témoignages',
      testimonialsText:
        'Témoignages à venir. Participez aux premières éditions pour donner votre avis !',
      galleryTitle: 'Éditions précédentes',
      galleryText:
        "Les captures des sessions d'ateliers, replays et moments forts des éditions précédentes seront affichés ici très prochainement.",
    },
    en: {
      title: 'Master Artificial Intelligence in your field',
      subtitle: 'Free live webinar',
      tagline:
        'Learn how to integrate AI into your profession to save time, boost your productivity, and develop new career opportunities.',
      ...
      aboutIntro:
        'Artificial intelligence is already transforming all sectors of activity.',
      ...
      aboutBody2:
        'this webinar will allow you to discover how to concretely use AI in your domain to improve efficiency, automate tasks, and create more value.',
      aboutBody3:
        'Every week, Fernando HOUSSOU shares practical methods, accessible tools, and real-life use cases adapted to African realities.',
      learnTitle: 'What you will learn',
      learnTagline:
        'A structured curriculum to go from curious to AI expert in your daily business workflows.',
      learnItems: [
        {
          num: '01',
          color: 'color-p1',
      ...
      themeText:
        'Learn how to use AI in your job to stay competitive and develop new strategic skills.',
      trainerLabel: 'YOUR INSTRUCTOR',
      trainerTitle: 'Your Instructor',
      trainerName: 'Fernando HOUSSOU',
      trainerRole:
        'Specialist in digital productivity, automation, and artificial intelligence integration in business domains.',
      trainerBio1:
        'Founder and director of several digital projects in Africa, he supports professionals and companies in their digital transformation.',
      trainerBio2:
        'Every week, he shares practical methods, accessible tools, and real-life use cases adapted to African realities.',
      ...
      ctaFinalText:
        'Join hundreds of African professionals who are already mastering AI.',
      ctaFinalBtn: 'Book my free seat',
      ctaFinalLimit: 'Seats limited to 250 participants per session',
      testimonialsTitle: 'Testimonials',
      testimonialsText:
        'Testimonials coming soon. Participate in the first editions to share your feedback!',
      galleryTitle: 'Previous Editions',
      galleryText:
        'Workshop session screenshots, replays, and key moments from previous editions will be displayed here soon.',
    },
  };
          ...
          <div className="webinar-extended-content">
              ...
              <div className="bento-grid">
                {t.learnItems.map((item, i) => (
                  <div className="glass-panel bento-card" key={i}>
                    <div className={`bento-card-number ${item.color}`}>
                      {item.num}
                    </div>
                    <h3>{item.title}</h3>
                    <p>{item.desc}</p>
            ...
            <section className="webinar-section relative py-12">
              ...
              <div className="glass-panel p-12 rounded-[2.5rem] text-center relative overflow-hidden">
                ...
                <blockquote>&ldquo;{t.themeQuote}&rdquo;</blockquote>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center mt-8">
                ...
                <div className="md:col-span-7">
                  <div className="trainer-card glass-panel">
                    <h4 className="font-label-caps text-accent mb-2 text-sm font-bold tracking-wider">
                      {t.trainerLabel}
                    </h4>
                    <h3 className="text-3xl font-extrabold mb-4">
                      {t.trainerName}
                    </h3>
                    <p className="text-on-surface font-bold text-lg mb-6">
                      {t.trainerRole}
                    </p>
            ...
            <section className="py-12 text-center relative mt-16">
              <div className="max-w-[800px] mx-auto py-16 px-8 rounded-[3rem] bg-gradient-to-b from-surface-container-high to-surface-container-lowest border border-white/5 relative overflow-hidden glass-panel">
                ...
                <p className="text-xs text-on-surface-variant/60 tracking-widest uppercase mt-6">
                  {t.ctaFinalLimit}
                </p>
              </div>
            </section>
